...
namespace SharePlatformSystem.Tests.Startup
{
    public class SharePlatformBootstraper_Tester : TestBaseWithLocalIocManager
    {
        private readonly SharePlatformBootstrapper _bootstrapper;
    ...
    public abstract class MyEventCounterModuleBase : SharePlatformModule
    {
