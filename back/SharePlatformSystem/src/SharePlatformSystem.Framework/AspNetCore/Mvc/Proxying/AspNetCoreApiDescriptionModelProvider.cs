...
using SharePlatformSystem.Framework.AspNetCore.Mvc.Proxying.Utils;
...
namespace SharePlatformSystem.Framework.AspNetCore.Mvc.Proxying
{
    public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ISingletonDependency
    {
        ...
        private readonly SharePlatformAspNetCoreConfiguration _configuration;
        ...
        public AspNetCoreApiDescriptionModelProvider(
            ...
            SharePlatformAspNetCoreConfiguration configuration,
        ...
        private string GetModuleName(ApiDescription apiDescription)
        {
            ...
            {
                return SharePlatformControllerAssemblySetting.DefaultServiceModuleName;
            }
