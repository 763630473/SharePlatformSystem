...
namespace SharePlatformSystem.Auditing
{
    public class AuditingHelper : IAuditingHelper, ITransientDependency
    {
        ...
        public bool ShouldSaveAudit(MethodInfo methodInfo, bool defaultValue = false)
        {
            ...
            if (!_configuration.IsEnabledForAnonymousUsers && (SharePlatformSession?.UserId == null))
            {
                return false;
            }
        ...
        public AuditInfo CreateAuditInfo(Type type, MethodInfo method, IDictionary<string, object> arguments)
        {
            ...
            {
                UserId = SharePlatformSession.UserId,
                ImpersonatorUserId = SharePlatformSession.ImpersonatorUserId,
