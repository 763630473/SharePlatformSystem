...
namespace SharePlatformSystem.Tests.Runtime.Caching.Memory
{
    public class MemoryCacheManager_Tests : TestBaseWithLocalIocManager
    {
        ...
        public MemoryCacheManager_Tests()
        {
            ...
            LocalIocManager.Register<ICacheManager, SharePlatformMemoryCacheManager>();
            LocalIocManager.Register<MyClientPropertyInjects>(DependencyLifeStyle.Transient);
            LocalIocManager.IocContainer.Register(Component.For<ISharePlatformStartupConfiguration>().Instance(Substitute.For<ISharePlatformStartupConfiguration>()));
