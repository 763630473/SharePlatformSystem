...
namespace SharePlatformSystem.TestBase
{
        ...
        where TStartupModule : AbpModule
    {
        ...
        /// </summary>
        protected TestSharePlatformSession AbpSession { get; private set; }
        ...
        {
            LocalIocManager.RegisterIfNot<IAbpSession, TestSharePlatformSession>();
            ...
            AbpSession = LocalIocManager.Resolve<TestSharePlatformSession>();
        }
